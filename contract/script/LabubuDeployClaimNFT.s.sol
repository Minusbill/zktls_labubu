...
contract DeployClaimNFTScript is Script {
    function run() public {
        ...
        // NFT基本信息
        string memory name = "LABUBU Collection";
        string memory symbol = "LABUBU";
        string memory baseURI = "https://orange-cautious-dove-71.mypinata.cloud/ipfs/bafybeiapgtif62ikj25gdzvau3l66ndah5r2uudb7keki3xhpyij7kr53e/";
